...
DEFAULT_CONTENT={   "board_startup_list":["To do", "Doing", "Done"],
                    "board_title":"Novo Quadro",
                    "note_style":"background-color: #ffffff; border: 1px solid #cccccc; border-radius: 5px;",
                    "note_title":"Título inicial",
                    "note_content":"Ola",
                    "note_expand_compress":"Expandir/Comprimir conteúdo",
                    "note_remove":"Remover nota"
                }
...
class NoteWidget(QWidget):
    def __init__(self, title="", content=""):
        ...
        self.setStyleSheet(CONFIG["note_style"])
...
class ColumnWidget(QFrame):
    def __init__(self, title=CONFIG["board_title"]):
        super().__init__()
        self.setAcceptDrops(True)
...
class KanbanWindow(QMainWindow):
    ...
    def add_column(self, title=CONFIG["board_title"]):
